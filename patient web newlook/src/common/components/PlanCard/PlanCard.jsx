...
export default function PlanCard({ plan, billing, addonByCode = {}, vertical, onSelect }) {
    ...
    // start — only a genuinely priced plan gets the trial CTA.
    ...
    return (
        ...
        >
            <CardContent sx={{ flex: 1, p: 3 }}>
                ...
                {!showBenefits && includedAddons.length > 0 && (
                    <>
                        <Typography variant="overline" color="text.secondary">
