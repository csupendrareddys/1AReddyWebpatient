...
export const sendEmailVerificationOtp = createAsyncThunk(
    ...
    async (_, { rejectWithValue }) => {
        try {
            const response = await axiosInstance.post('/auth/email/send-verification');
...
export const verifyEmailOtp = createAsyncThunk(
    ...
    async ({ otp }, { rejectWithValue }) => {
        try {
            const response = await axiosInstance.post('/auth/email/verify', { otp });
            return response.data;
        } catch (error) {
            return rejectWithValue(parseErrorResponse(error));
        }
...
export const sendPreSignupPhoneOtp = createAsyncThunk(
    ...
    async (arg, { rejectWithValue }) => {
        ...
        try {
            ...
            const response = await axiosInstance.post('/auth/pre-signup/send-phone-otp', payload);
            return response.data;
        } catch (error) {
            return rejectWithValue(parseErrorResponse(error));
        }
...
export const verifyPreSignupPhoneOtp = createAsyncThunk(
    ...
    async ({ phone_number, otp }, { rejectWithValue }) => {
        try {
            const response = await axiosInstance.post('/auth/pre-signup/verify-phone-otp', {
                phone_number,
                otp,
            });
    ...
    async (arg, { rejectWithValue }) => {
        ...
        try {
            ...
            const response = await axiosInstance.post(
                '/auth/pre-signup/send-email-otp', payload,
            );
            return response.data;
        } catch (error) {
            return rejectWithValue(parseErrorResponse(error));
...
export const verifyPreSignupEmailOtp = createAsyncThunk(
    ...
    async ({ email, otp }, { rejectWithValue }) => {
        try {
            const response = await axiosInstance.post(
                '/auth/pre-signup/verify-email-otp', { email, otp },
            );
            return response.data.data; // { token }
        } catch (error) {
            return rejectWithValue(parseErrorResponse(error));
