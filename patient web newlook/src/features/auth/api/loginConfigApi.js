...
export const fetchLoginPageConfig = async () => {
    const response = await axios.get('/api/config/login-page');
...
export const fetchAdminLoginPageConfig = async () => {
    const response = await axios.get('/api/config/admin/login-page');
    return response.data;
};
...
export const updateLoginPageConfig = async (data) => {
    const response = await axios.put('/api/config/admin/login-page', data);
    return response.data;
};
...
export const addLoginField = async (fieldData) => {
    const response = await axios.post('/api/config/admin/login-page/field', fieldData);
    return response.data;
};
...
export const updateLoginField = async (fieldId, data) => {
    const response = await axios.put(`/api/config/admin/login-page/field/${fieldId}`, data);
    return response.data;
};
...
export const deleteLoginField = async (fieldId) => {
    const response = await axios.delete(`/api/config/admin/login-page/field/${fieldId}`);
    return response.data;
};
...
export const updateUserType = async (userTypeId, data) => {
    const response = await axios.put(`/api/config/admin/login-page/user-type/${userTypeId}`, data);
    return response.data;
};
...
export const addExtraButton = async (buttonData) => {
    const response = await axios.post('/api/config/admin/login-page/extra-button', buttonData);
    return response.data;
};
...
export const updateExtraButton = async (buttonId, data) => {
    const response = await axios.put(`/api/config/admin/login-page/extra-button/${buttonId}`, data);
    return response.data;
};
...
export const deleteExtraButton = async (buttonId) => {
    const response = await axios.delete(`/api/config/admin/login-page/extra-button/${buttonId}`);
    return response.data;
};
