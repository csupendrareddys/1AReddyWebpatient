...
export const fetchDoctors = createAsyncThunk(
    ...
    async (params = {}, { rejectWithValue }) => {
        try {
            ...
            const response = await axiosInstance.get(`/api/doctor/list?${queryParams}`);
...
export const fetchDoctorDetail = createAsyncThunk(
    ...
    async (doctorId, { rejectWithValue }) => {
        try {
            ...
            const response = await axiosInstance.get(`/api/doctor/${doctorId}/public`);
...
export const fetchSymptoms = createAsyncThunk(
    ...
    async (category = null, { rejectWithValue }) => {
        try {
            const url = category
                ? `/api/patient/symptoms?category=${category}`
...
export const fetchPlatforms = createAsyncThunk(
    ...
    async (_, { rejectWithValue }) => {
        try {
            ...
            const response = await axiosInstance.get('/api/patient/platforms');
...
export const fetchUpcomingOrders = createAsyncThunk(
    ...
    async (params = {}, { rejectWithValue }) => {
        try {
            ...
            const response = await axiosInstance.get('/api/appointment/patient/upcoming');
    ...
    async (params = {}, { rejectWithValue }) => {
        try {
            ...
            const response = await axiosInstance.get(
                `/api/appointment/patient/history?page=${page}&per_page=${per_page}`
            );
...
export const bookAppointment = createAsyncThunk(
    ...
    async (appointmentData, { rejectWithValue }) => {
        try {
            ...
            // NO trailing slash — backend route is ``/api/appointment``
            // (Flask strict_slashes=True). Posting to ``/api/appointment/``
            // 404s the CORS preflight and breaks the booking flow.
            const response = await axiosInstance.post('/api/appointment', appointmentData);
...
export const cancelAppointment = createAsyncThunk(
    ...
    async (appointmentId, { rejectWithValue }) => {
        try {
            ...
            const response = await axiosInstance.post(`/api/appointment/${appointmentId}/cancel`);
...
export const fetchOrderDetail = createAsyncThunk(
    ...
    async (orderId, { rejectWithValue }) => {
        try {
            ...
            const response = await axiosInstance.get(`/api/patient/orders/${orderId}`);
...
export const submitRating = createAsyncThunk(
    ...
    async ({ orderId, rating, review, is_anonymous = false }, { rejectWithValue }) => {
        try {
            ...
            const response = await axiosInstance.post(`/api/patient/orders/${orderId}/rating`, {
                rating,
                review,
                is_anonymous,
            });
...
export const addDocument = createAsyncThunk(
    ...
    async ({ orderId, document_name, attachment_link, description, document_type }, { rejectWithValue }) => {
        try {
            ...
            const response = await axiosInstance.post(`/api/patient/orders/${orderId}/documents`, {
                document_name,
                attachment_link,
                description,
                document_type,
...
export const fetchHouseGroup = createAsyncThunk(
    ...
    async (_, { rejectWithValue }) => {
        try {
            ...
            const response = await axiosInstance.get('/api/patient/house-group');
...
export const addHouseGroupMember = createAsyncThunk(
    ...
    async (data, { rejectWithValue }) => {
        try {
            ...
            const response = await axiosInstance.post('/api/patient/house-group', data);
...
export const updateHouseGroupMember = createAsyncThunk(
    ...
    async ({ memberId, data }, { rejectWithValue }) => {
        try {
            ...
            const response = await axiosInstance.put(`/api/patient/house-group/${memberId}`, data);
...
export const deleteHouseGroupMember = createAsyncThunk(
    ...
    async (memberId, { rejectWithValue }) => {
        try {
            ...
            await axiosInstance.delete(`/api/patient/house-group/${memberId}`);
...
export const sendOtp = createAsyncThunk(
    ...
    async ({ identifier, purpose, scope = null }, { rejectWithValue }) => {
        try {
            ...
            const url = scope ? patientScopedUrl(scope, '/send-otp') : '/api/patient/send-otp';
...
export const verifyAndUpdateContact = createAsyncThunk(
    ...
    async ({ identifier, otp, purpose, scope = null }, { rejectWithValue }) => {
        try {
            ...
            const url = scope ? patientScopedUrl(scope, '/verify-and-update') : '/api/patient/verify-and-update';
