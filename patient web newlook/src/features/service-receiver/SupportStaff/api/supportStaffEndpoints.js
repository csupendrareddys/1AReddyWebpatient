/**
 * Patient support-staff endpoints — base ``/api/patient-staff``.
 *
 * Two audiences:
 ...
 *
 * Roles themselves are authored via the shared ``/api/patient-family/roles``
