...
const AdminSidebar = ({ isOpen, onToggle }) => {
    ...
    const navItems = [
        ...
        },
        {
            ...
            visible: hasFullAccess || can('patient_list', 'view'),
        },
        {
            ...
            visible: hasFullAccess || can('appointment_list', 'view'),
        },
        {
        ...
        },
        {
            ...
            visible: hasFullAccess || can('manage_medicine_catalog', 'view'),
        },
        {
            label: 'Prescription / Document PDF Editor',
            icon: DescriptionIcon,
            path: '/dashboard/admin/prescription-template',
            visible: hasFullAccess && hasFeature('doctor.prescriptions_pdf'),
        },
        {
        ...
        },
        {
            ...
            visible: hasFullAccess && hasFeature('admin.billing_config'),
        },
        {
