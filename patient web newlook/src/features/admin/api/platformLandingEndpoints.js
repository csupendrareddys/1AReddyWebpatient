 ...
 *
 * Mounted at ``/api/platform-landing/*`` (admin) and
 * ``/api/public/platform-landing`` (public read).
 */
import { apiSlice } from '../../../app/api/apiSlice';

const ADMIN = '/api/platform-landing/admin';
const PUBLIC = '/api/public/platform-landing';
...
const platformLandingEndpoints = apiSlice.injectEndpoints({
    endpoints: (builder) => ({
        ...
        // keep calling ``/api/landing/public/...`` on the apex too, which
