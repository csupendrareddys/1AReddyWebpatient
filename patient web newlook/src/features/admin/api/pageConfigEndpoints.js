...
const API_BASE = '/api/page-config';
...
export const fetchPublicPageConfig = async (pageType, lang = 'en', tenantSlug = null) => {
    ...
    const response = await axiosInstance.get(
        `/api/page-config/public/${pageType}`, { params },
    );
...
export const fetchPageTypes = async () => {
    const response = await axiosInstance.get('/api/page-config/public/types');
    return response.data;
};
...
export const uploadAsset = async (file, assetType, name) => {
    ...
    const response = await axiosInstance.post('/api/page-config/admin/assets', formData, {
        headers: {
