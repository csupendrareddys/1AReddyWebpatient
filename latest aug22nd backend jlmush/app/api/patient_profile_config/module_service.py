"""Patient Profile — per-module lifecycle service (Round 9, Phase 3)."""
from __future__ import annotations

from app.common.module_lifecycle import ModuleLifecycle, build_lifecycle
from app.api.patient_profile_config.modules import (
...
PAGE_TYPE = PageType.PATIENT_PROFILE
PAGE_TYPE_STR = 'patient_profile'
...
def for_module(module: str) -> ModuleLifecycle:
    return build_lifecycle(
        ...
        default_fields=PATIENT_PROFILE_FIELDS,
    )
