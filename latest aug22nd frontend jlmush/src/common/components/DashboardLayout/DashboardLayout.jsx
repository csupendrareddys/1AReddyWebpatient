    ...
    return (
        <div className={`dashboard-layout ${isDarkMode ? 'dark-mode' : ''} ${!sidebarOpen ? 'dashboard-layout--collapsed' : ''}`}>
            ...
            <div className="dashboard-layout__content-wrapper">
                <DashboardTopBar onToggleSidebar={toggleSidebar} sidebarOpen={sidebarOpen} accentColor={config.accentColor} profilePath={config.profilePath} loginPath={config.loginPath} />
