 ...
 * base (``/api/v1/patient`` for {@link patientScoped}, ``/api/v1`` for
    ...
    endpoints: (builder) => ({
        ...
        bookAppointment: builder.mutation({
            query: apiScoped((appointmentData) => ({
                ...
                // which Flask serves at ``/api/v1/appointment`` only.
                // ``/api/v1/appointment/`` (with slash) 404s the CORS preflight,
        ...
        getPatientMembership: builder.query({
            query: () => ({ url: '/api/v1/membership/me', method: 'GET' }),
        ...
        // patient's own ``/api/v1/patient/*`` routes; through the Operations
