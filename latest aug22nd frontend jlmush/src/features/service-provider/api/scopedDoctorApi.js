 ...
 *     ``/api/v1/admin/operations/doctor-members/<id>/act/...`` with per-doctor
 *     cache entries.
 *
...
import {
    ...
    useGetMyDoctorDocumentsQuery as _useGetMyDoctorDocumentsQuery,
...
export const useGetMyDoctorDocumentsQuery = scopedQuery(_useGetMyDoctorDocumentsQuery);
