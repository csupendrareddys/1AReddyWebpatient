...
import { useGetMyBillingQuery, useGetMyPayoutsQuery, useGetPayoutBillQuery, useLazyGetPayoutBillPdfQuery, useClaimPayoutMutation, useClaimAllPayoutsMutation, useGetDoctorSalaryPayoutsQuery, useGetPayoutPreferenceQuery, useSetPayoutPreferenceMutation } from '../../api/doctorEndpoints';
...
const MyBillsPage = () => {
    ...
    const { data: billingData, isLoading: billingLoading, isFetching: billingFetching, error: billingError } = useGetMyBillingQuery(billingParams);
    ...
    const { data: payoutData, isLoading: payoutLoading, isFetching: payoutFetching, error: payoutError } = useGetMyPayoutsQuery(payoutParams);
