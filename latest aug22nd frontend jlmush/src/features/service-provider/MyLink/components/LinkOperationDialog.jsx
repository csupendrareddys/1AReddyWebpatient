 ...
 * ``/api/v1/doctor/...`` as the clinic and 403. Closing navigates back, which is
 ...
 * is ``link``. Every request re-points to ``/api/v1/facility/link/doctors/<id>/
 ...
 *
 * 5 Analytics and 6 Attendance & Activity read ``/api/v1/doctor-analytics/<id>/*``
