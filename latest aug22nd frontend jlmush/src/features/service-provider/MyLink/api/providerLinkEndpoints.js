 ...
 * doctor's own care-network routes (``/api/v1/doctor/network/*``,
 ...
 * row it has no read on. ``/api/v1/facility/link/*`` is that missing read.
 *
...
const LINK_URL = '/api/v1/facility/link';
