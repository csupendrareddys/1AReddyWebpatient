...
const SessionLimitDialog = ({ open, onClose, credentials, onSuccess }) => {
    ...
    const fetchSessions = async () => {
        ...
        setError('');
        try {
            const response = await axiosInstance.post('/api/v1/auth/active-sessions', credentials);
    ...
    const handleLogoutAll = async () => {
        ...
        setError('');
        try {
            await axiosInstance.post('/api/v1/auth/force-logout-all', credentials);
    ...
    const handleLogoutSession = async (sessionId) => {
        ...
        setError('');
        try {
            await axiosInstance.post('/api/v1/auth/force-logout-session', {
                ...credentials,
