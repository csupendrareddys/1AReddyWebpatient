...
import { useGetWorkQualificationsQuery, useGetProductCategoriesQuery } from '../../../api/marketplaceEndpoints';
...
const GroupOfferingsBuilder = () => {
    ...
    // Option sources for the targeting section.
    ...
    return (
        <Box sx={{ p: 3, maxWidth: 1100, mx: 'auto' }}>
            ...
            {/* Section 3.5 — Audience targeting. Edits stay in draft state
                and ride Save draft / Publish (one API call). */}
            <Paper sx={{ p: 3, mb: 3, borderRadius: 2 }}>
                <Typography variant="h6" fontWeight={600} gutterBottom>
                    Targeting — who sees this plan first
                </Typography>
                <Divider sx={{ mb: 2 }} />
                <TargetingSection
                    value={draft.targeting}
                    onChange={(t) => setDraft((d) => ({ ...d, targeting: t }))}
