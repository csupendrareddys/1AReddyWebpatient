/**
 * ApprovalsHub — Page-Controls-style organizer for all admin approvals.
 * Sections (Admin / Service Provider / Service Receiver) → module cards → each
 * card opens its approval queue. Cards are filtered by the admin's RBAC scopes
 * in useApprovalsHub, so a sub-admin sees only the approval types assigned to
 * them.
 */
import {
...
import useApprovalsHub, { moduleButtonStyle, disabledButtonStyle } from '../../hooks/useApprovalsHub';
...
const ApprovalsHub = () => {
        ...
        return (
            <Paper sx={{ textAlign: 'center', py: 4 }}>
                ...
                <Typography color="text.secondary" sx={{ mt: 1 }}>
                    You do not have permission to review approvals.
                </Typography>
            </Paper>
        );
    }
    ...
    const renderSectionSelection = () => (
        <Box>
            ...
            <Typography variant="body1" color="text.secondary" textAlign="center" sx={{ mb: 4 }}>
                Choose whose approvals to review
            </Typography>
    ...
    return (
        <Box>
            <Typography variant="h5" fontWeight={600} sx={{ mb: 2 }}>Approvals</Typography>
