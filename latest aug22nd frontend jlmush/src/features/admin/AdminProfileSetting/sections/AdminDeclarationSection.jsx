...
import {
    ...
    ToggleButtonGroup, ToggleButton, Checkbox, FormControlLabel, Divider,
} from '@mui/material';
...
const AdminDeclarationSection = React.memo(({ previewMode = false, configOverride = null, registerSave }) => {
    const {
        declarationState,
        handleAnswerChange,
        ...
        handleSave,
    } = useAdminDeclaration(previewMode);
...
AdminDeclarationSection.displayName = 'AdminDeclarationSection';
export default AdminDeclarationSection;
