    ...
    return (
        <Box sx={{ p: 3, maxWidth: 900, mx: 'auto' }}>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                Add a family doctor to your account and get a free second opinion on consultations and services.
            </Typography>
                        ...
                        : hasFamilyDoctor ? (
                            <>
                                ...
                                <Typography variant="body2" color="text.secondary" sx={{ mt: 1.5 }}>
                                    This is your family doctor. You can view the second opinion provided by your family doctor for your completed bookings.
                                </Typography>
                            </>
                        ) : (
